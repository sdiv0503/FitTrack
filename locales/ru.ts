export default {
  ...
  premium: {
    ...
    already_premium: "Вы наслаждаетесь fittrack Premium",
    no_ads: "Без рекламы",
    upgrade: "Обновить",
    ...
    faq: {
      ...
      subtitle: "Все, что вам нужно знать о fittrack и нашей миссии",
      items: [
        {
        ...
        {
          question: "Могу ли я самохостить fittrack?",
          answer:
      ...
      additional_support: {
        ...
        community: "Поддержка сообщества (дискорд или hello@fittrack)",
    ...
    free_intro_text:
      "fittrack — это бесплатное приложение для фитнеса с открытым исходным кодом, которым ежедневно пользуются более 60 000 пользователей. Оно создано с любовью (а не на деньги венчурных фондов ^^) и требует реальных затрат времени и денег для поддержки.",
    donation_story_text:
    ...
    health_upgrade_text: "Если fittrack помогает вам улучшить здоровье, пожалуйста, рассмотрите возможность перехода на Премиум :D !",
    ...
    still_unsure: "Все еще не уверены? Не волнуйтесь. fittrack всегда останется бесплатным и с открытым исходным кодом.",
  ...
  release_notes: {
    ...
    notes: {
      ...
      note_2025_06_23: {
        ...
        content:
          "Приложение теперь поддерживает <strong>португальский язык</strong>! Мы также добавили <em>баннер пожертвований</em>, чтобы помочь покрыть расходы проекта через <a href='https://github.com/sponsors/snouzy' target='_blank' rel='noopener' class='text-blue-500 hover:underline'>GitHub Sponsors</a> или <a href='https://ko-fi.com/fittrack' target='_blank' rel='noopener' class='text-blue-500 hover:underline'>Ko-fi</a>. 🙏",
      },
      note_2025_06_22: {
      ...
      note_2025_06_19: {
        ...
        content:
          "fittrack v1.2 теперь является прогрессивным веб-приложением! Установите его на ваш телефон для получения нативного опыта приложения с офлайн доступом. 🚀",
      },
      note_2025_06_18: {
        title:
        ...
        content:
          "fittrack достиг первого места на Hacker News! Спасибо всем за потрясающую поддержку и добро пожаловать всем новым пользователям! 💪",
      },
      note_2025_06_01: {
  ...
  donation_alert: {
    title: "Разблокируйте расширенные функции с fittrack Premium",
    or: "или",
  },
  ...
  commons: {
    ...
    discover_fittrack: "Откройте fittrack",
