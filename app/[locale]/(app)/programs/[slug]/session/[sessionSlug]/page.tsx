...
export async function generateMetadata({ params }: SessionDetailPageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: sessionMetadata.title,
      description: sessionMetadata.description,
      url: `https://www.fittrack/${locale}/programs/${slug}/session/${sessionSlug}`,
      siteName: "fittrack",
      images: [
        {
          url: imageUrl,
    ...
    alternates: {
      canonical: `https://www.fittrack/${locale}/programs/${slug}/session/${sessionSlug}`,
      languages: {
        "fr-FR": `https://www.fittrack/fr/programs/${slug}/session/${sessionSlug}`,
        "en-US": `https://www.fittrack/en/programs/${slug}/session/${sessionSlug}`,
        "es-ES": `https://www.fittrack/es/programs/${slug}/session/${sessionSlug}`,
        "pt-PT": `https://www.fittrack/pt/programs/${slug}/session/${sessionSlug}`,
        "ru-RU": `https://www.fittrack/ru/programs/${slug}/session/${sessionSlug}`,
        "zh-CN": `https://www.fittrack/zh-CN/programs/${slug}/session/${sessionSlug}`,
        "x-default": `https://www.fittrack/programs/${slug}/session/${sessionSlug}`,
      },
    },
    robots: {
      index: true,
