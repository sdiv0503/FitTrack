# Política de Privacidade fittrack

## 1. Introdução

Na **fittrack**, levamos a privacidade dos nossos usuários muito a sério.  
...
**Informações pessoais**: Quando você se cadastra, coletamos seu nome, endereço de e-mail e outros detalhes relacionados à sua atividade no fittrack.

**Dados de uso**: Rastreamos interações com as páginas do fittrack, incluindo cliques, visualizações e desempenho de links.
