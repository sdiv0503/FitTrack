# Política de Privacidad de fittrack

## 1. Introducción

En **fittrack**, tomamos muy en serio la privacidad de nuestros usuarios.  
...
**Información personal**: Cuando se registra, recopilamos su nombre, dirección de correo electrónico y otros detalles relacionados con su actividad en fittrack.

**Datos de uso**: Rastreamos las interacciones con las páginas de fittrack, incluyendo clics, vistas y rendimiento de enlaces.
