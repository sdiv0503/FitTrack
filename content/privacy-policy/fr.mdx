# Politique de Confidentialité fittrack

## 1. Introduction

Chez **fittrack**, nous accordons une grande importance à la confidentialité de nos utilisateurs.  
...
**Informations personnelles** : lorsque vous vous inscrivez, nous collectons votre nom, votre adresse e-mail, et d’autres informations liées à votre activité sur fittrack.

**Données d’utilisation** : nous suivons les interactions avec les pages fittrack, notamment les clics, les vues et les performances des liens.
...
fittrack utilise des cookies pour :
...
**[hello@fittrack.io](mailto:hello@fittrack.io)**
