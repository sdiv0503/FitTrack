...
fittrack was born out of the desire to offer a reliable, modern, and actively maintained workout platform, after the original project <WorkoutLol variant="muted" /> was abandoned.

## The Story

fittrack is the result of a community-driven adventure.
...
fittrack is open source, ensuring transparency, modularity, and scalability.  
Everyone is welcome to contribute—code, documentation, or ideas!

- [See the project on GitHub](https://github.com/Snouzy/fittrack)
- [Buy a coffee to support](https://ko-fi.com/fittrack)
