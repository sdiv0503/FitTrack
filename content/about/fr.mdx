...
# À propos de fittrack

## Pourquoi fittrack ?

fittrack est né de la volonté de proposer une plateforme d'entraînement fiable, moderne et maintenue, après l'abandon du projet <WorkoutLol variant="muted" />.

## L'histoire

fittrack est le fruit d'une aventure communautaire.
...
fittrack est open source, garantir transparence, modularité et évolutivité.  
Toute contribution est la bienvenue, que ce soit pour le code, la documentation ou les idées !

- [Voir le projet sur GitHub](https://github.com/Snouzy/fittrack)
- [Payer un café en guise de soutien](https://ko-fi.com/fittrack)
