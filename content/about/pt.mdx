...
fittrack nasceu do desejo de oferecer uma plataforma de treino confiável, moderna e ativamente mantida, após o projeto original <WorkoutLol variant="muted" /> ter sido abandonado.

## A história

fittrack é o resultado de uma aventura impulsionada pela comunidade.
...
fittrack é open source, garantindo transparência, modularidade e escalabilidade.
Todos são bem-vindos para contribuir com código, documentação ou ideias!

- [Ver o projeto no GitHub](https://github.com/Snouzy/fittrack)
- [Comprar um café para apoiar](https://ko-fi.com/fittrack)
