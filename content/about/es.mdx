...
fittrack nació del deseo de ofrecer una plataforma de entrenamiento confiable, moderna y activamente mantenida, después de que el proyecto original <WorkoutLol variant="muted" /> fuera abandonado.

## La historia

fittrack es el resultado de una aventura impulsada por la comunidad.
...
fittrack es de open source, garantizando transparencia, modularidad y escalabilidad.
¡Todos son bienvenidos a contribuir—código, documentación o ideas!

- [Ver el proyecto en GitHub](https://github.com/Snouzy/fittrack)
- [Comprar un café para apoyar](https://ko-fi.com/fittrack)
...
**[hello@fittrack](mailto:hello@fittrack)**