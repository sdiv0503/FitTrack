# Términos Generales de Venta – fittrack

## ARTÍCULO 1: Objeto

Estos términos rigen la prestación de servicios ofrecidos a través de la plataforma fittrack (modelo SaaS).  
Al suscribirse a un plan o usar la aplicación fittrack, el Cliente acepta completa e incondicionalmente estos Términos de Venta, junto con los Términos de Uso y la Política de Privacidad.
...
- **Aplicación**: la aplicación web de fittrack (y aplicación móvil cuando esté disponible).  
- **Cliente**: el usuario de la plataforma, ya sea para uso personal o profesional.  
- **Empresa**: se refiere a fittrack, operada por Mathias BRADICEANU.

## ARTÍCULO 3: Pedido y activación

Las suscripciones se compran en línea a través de fittrack.io.  
...
Cualquier solicitud de desistimiento debe enviarse a [support@fittrack.io](mailto:support@fittrack.io) o por correo certificado a la dirección registrada de la Empresa.
...
- Respetar los derechos de propiedad intelectual de fittrack  
...
fittrack no será responsable de:
...
El Cliente acepta indemnizar y eximir de responsabilidad a fittrack de cualquier reclamo, pérdida o responsabilidad que surja del mal uso, uso ilegal o incumplimiento de estos términos, incluyendo honorarios legales y administrativos.

## ARTÍCULO 9: Cambios en los términos

fittrack se reserva el derecho de actualizar estos Términos de Venta en cualquier momento.  
...
fittrack no será responsable de cualquier falla o retraso causado por eventos más allá de su control razonable, tales como:  
...
Los registros digitales almacenados por los sistemas de fittrack constituyen prueba válida de transacciones y comunicaciones.  
Las facturas están disponibles en cualquier momento en la cuenta del usuario.

## ARTÍCULO 12: Contacto – Quejas

Para preguntas, quejas o problemas, los Clientes pueden contactar a fittrack:

- Por email: [support@fittrack.io](mailto:support@fittrack.io)  
