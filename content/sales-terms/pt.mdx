# Termos Gerais de Venda – fittrack

## ARTIGO 1: Objeto

Estes termos regem a prestação de serviços oferecidos através da plataforma fittrack (modelo SaaS).  
Ao se inscrever em um plano ou usar a aplicação fittrack, o Cliente concorda total e incondicionalmente com estes Termos de Venda, juntamente com os Termos de Uso e Política de Privacidade.
...
- **Aplicação**: a aplicação web fittrack (e aplicação móvel quando disponível).  
- **Cliente**: o usuário da plataforma, seja para uso pessoal ou profissional.  
- **Empresa**: refere-se à fittrack, operada por Mathias BRADICEANU.

## ARTIGO 3: Pedido e ativação

As assinaturas são adquiridas online através de fittrack.io.  
...
Qualquer solicitação de desistência deve ser enviada para [support@fittrack.io](mailto:support@fittrack.io) ou por correio registrado para o endereço registrado da Empresa.
...
- Respeitar os direitos de propriedade intelectual da fittrack  
...
fittrack não será responsável por:
...
O Cliente concorda em indenizar e isentar a fittrack de qualquer reivindicação, perda ou responsabilidade decorrente de uso indevido, uso ilegal ou violação destes termos, incluindo taxas legais e administrativas.

## ARTIGO 9: Alterações nos termos

fittrack reserva-se o direito de atualizar estes Termos de Venda a qualquer momento.  
...
fittrack não será responsabilizada por qualquer falha ou atraso causado por eventos além de seu controle razoável, tais como:  
...
Os registros digitais armazenados pelos sistemas da fittrack constituem prova válida de transações e comunicações.  
As faturas estão disponíveis a qualquer momento na conta do usuário.

## ARTIGO 12: Contato – Reclamações

Para perguntas, reclamações ou problemas, os Clientes podem contatar a fittrack:
