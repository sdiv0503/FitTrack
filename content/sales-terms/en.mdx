# General Terms of Sale – fittrack

## ARTICLE 1: Purpose

These terms govern the provision of services offered via the fittrack platform (SaaS model).  
By subscribing to a plan or using the fittrack application, the Client fully and unconditionally agrees to these Terms of Sale, along with the Terms of Use and Privacy Policy.
...
- **Application**: the fittrack web application (and mobile app when available).  
- **Client**: the user of the platform, whether for personal or professional use.  
- **Company**: refers to fittrack, operated by Mathias BRADICEANU.

## ARTICLE 3: Ordering and Activation

Subscriptions are purchased online via fittrack.io.  
...
Any withdrawal request must be sent to [support@fittrack.io](mailto:support@fittrack.io) or by registered mail to the Company's registered address.
...
- Respect fittrack’ intellectual property rights  
...
fittrack shall not be liable for:
...
The Client agrees to indemnify and hold harmless fittrack from any claim, loss, or liability arising from misuse, unlawful use, or breach of these terms, including legal and administrative fees.

## ARTICLE 9: Changes to the Terms

fittrack reserves the right to update these Terms of Sale at any time.  
...
fittrack shall not be held liable for any failure or delay caused by events beyond its reasonable control, such as:  
...
Digital records stored by fittrack’ systems constitute valid proof of transactions and communications.  
Invoices are available at any time in the user’s account.

## ARTICLE 12: Contact – Complaints

For questions, complaints, or issues, Clients can contact fittrack:

- By email: [support@fittrack.io](mailto:support@fittrack.io)  
