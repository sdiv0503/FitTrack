# Terms of Use – fittrack

These Terms of Use ("Terms") define the conditions for accessing and using the services provided by the fittrack platform and govern the rights and obligations between fittrack and its users.

_Last updated: May 3, 2025_

## ARTICLE 1: Legal Notice

The website fittrack.io is published by **Mathias BRADICEANU**.
...
fittrack collects and stores personal data entered by users or automatically generated while using the service.  
...
All elements of the fittrack platform (text, images, code, logo, interface, web components, etc.) are protected by intellectual property law and remain the exclusive property of fittrack or its partners.  
Any reproduction, distribution, or commercial use without prior written consent is strictly prohibited.

User accounts and hosted content are non-transferable and subject to fittrack’ approval.
...
In case of violation, fittrack may suspend or delete the offending account without notice or refund.

## ARTICLE 6: Availability and Disclaimer of Warranty

fittrack makes every effort to provide a stable and secure service.  
...
fittrack shall not be held liable for any direct or indirect damages, including material or immaterial losses, arising from:
...
If fittrack is found liable, its responsibility is expressly limited to the amount of the last subscription payment made by the user.

## ARTICLE 8: Suspension or Termination of Account

fittrack reserves the right to suspend or terminate any account:
...
fittrack may modify its services, features, pricing, or access conditions at any time.  
...
fittrack is not responsible for the content, security, or performance of external websites.
...
fittrack does not guarantee automated data portability to third-party services unless explicitly stated in a dedicated offer.

## ARTICLE 12: Indemnification

Users agree to defend, indemnify, and hold harmless fittrack from any claims, liabilities, losses, damages, or expenses (including legal fees) arising from:
...
fittrack shall not be held liable for failure to fulfill its obligations in the event of force majeure, including but not limited to: natural disaster, fire, flood, riot, war, pandemic, strike, cyberattack, infrastructure failure, or any other unforeseeable event beyond its control.
