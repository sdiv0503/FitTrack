# Termos de Uso – fittrack

Estes Termos de Uso ("Termos") definem as condições para acessar e usar os serviços fornecidos pela plataforma fittrack e regem os direitos e obrigações entre fittrack e seus usuários.

_Última atualização: 3 de maio de 2025_

## ARTIGO 1: Aviso Legal

O site fittrack.io é publicado por **Mathias BRADICEANU**.

O site é hospedado pela **Vercel Inc.**, 440 N Barranca Ave #4133, Covina, CA 91723, EUA.

## ARTIGO 2: Acesso à Plataforma

fittrack permite aos usuários:
...
fittrack coleta e armazena dados pessoais inseridos pelos usuários ou gerados automaticamente durante o uso do serviço.  
...
Todos os elementos da plataforma fittrack (texto, imagens, código, logo, interface, componentes web, etc.) são protegidos pela lei de propriedade intelectual e permanecem propriedade exclusiva da fittrack ou seus parceiros.  
Qualquer reprodução, distribuição ou uso comercial sem consentimento prévio por escrito é estritamente proibido.

As contas de usuário e conteúdo hospedado não são transferíveis e estão sujeitos à aprovação da fittrack.
...
Em caso de violação, fittrack pode suspender ou excluir a conta infratora sem aviso ou reembolso.

## ARTIGO 6: Disponibilidade e Isenção de Garantia

fittrack faz todos os esforços para fornecer um serviço estável e seguro.  
...
fittrack não será responsabilizada por quaisquer danos diretos ou indiretos, incluindo perdas materiais ou imateriais, decorrentes de:
...
Se fittrack for considerada responsável, sua responsabilidade é expressamente limitada ao valor do último pagamento de assinatura feito pelo usuário.

## ARTIGO 8: Suspensão ou Terminação de Conta

fittrack reserva-se o direito de suspender ou terminar qualquer conta:
...
fittrack pode modificar seus serviços, recursos, preços ou condições de acesso a qualquer momento.  
...
fittrack não é responsável pelo conteúdo, segurança ou desempenho de sites externos.
...
fittrack não garante portabilidade automatizada de dados para serviços de terceiros, a menos que explicitamente declarado em uma oferta dedicada.

## ARTIGO 12: Indenização

Os usuários concordam em defender, indenizar e isentar fittrack de quaisquer reivindicações, responsabilidades, perdas, danos ou despesas (incluindo honorários legais) decorrentes de:
...
fittrack não será responsabilizada pelo não cumprimento de suas obrigações em caso de força maior, incluindo mas não limitado a: desastre natural, incêndio, inundação, tumulto, guerra, pandemia, greve, ciberataque, falha de infraestrutura, ou qualquer outro evento imprevisto fora de seu controle.